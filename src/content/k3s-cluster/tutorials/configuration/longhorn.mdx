...
[![Longhorn: Node Drain](/k3s-cluster/tutorials/longhorn-node-drain.webp)](/k3s-cluster/tutorials/longhorn-node-drain.webp)

And the related volume replicas rebuild status:

[![Longhorn: Replicas Rebuild](/k3s-cluster/tutorials/longhorn-replicas-rebuild.webp)](/k3s-cluster/tutorials/longhorn-replicas-rebuild.webp)
