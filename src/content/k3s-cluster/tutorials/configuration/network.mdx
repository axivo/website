...
[![OS Installation: Network VLAN](/k3s-cluster/tutorials/network-vlan.webp)](/k3s-cluster/tutorials/network-vlan.webp)
...
[![OS Installation: Network Static IP](/k3s-cluster/tutorials/network-static-ip.webp)](/k3s-cluster/tutorials/network-static-ip.webp)
