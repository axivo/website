...
description: >-
  Advanced configuration options for customizing the framework environment beyond the standard setup.
---

# Advanced Settings

Advanced configuration options for users who want to customize their framework environment beyond the standard [Getting Started](/claude/wiki) setup.
