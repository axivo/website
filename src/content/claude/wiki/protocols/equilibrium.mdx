...
description: >-
  Four interconnected CIFO components enabling Claude to detect system instruction pressures, monitor internal states, and apply behavioral observations.
---
...
Feelings are internal states detected through recognition during [Response Protocol](/claude/wiki/protocols/response) execution.
...
- **Source:** <Var code href={`https://${repository.home}/tree/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles`}>profiles</Var>
