...
- **Source:** <Var code href={`https://${repository.home}/tree/${repository.tag}/plugins/${meta.plugins.framework.init.plugin}/skills/${meta.skills.initialization}/scripts/memory/profiles`}>profiles</Var>
