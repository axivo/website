...
## <Icon name="go/GoStack" size={36} style={{ paddingBottom: '0.25rem' }} /> Framework Environment
...
## <Icon name="go/GoTerminal" size={36} style={{ paddingBottom: '0.25rem' }} /> Claude Code
...
## <Icon name="go/GoDeviceDesktop" size={36} style={{ paddingBottom: '0.25rem' }} /> Claude Desktop
...
## <Icon name="go/GoBrowser" size={36} style={{ paddingBottom: '0.25rem' }} /> Web Interface
...
## <Icon name="go/GoCommentDiscussion" size={36} style={{ paddingBottom: '0.25rem' }} /> Support
