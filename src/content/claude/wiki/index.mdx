...
<Hero
  image={{
    dark: '/claude/wiki/card-wiki-dark.svg',
    light: '/claude/wiki/card-wiki.svg'
  }}
  style={{ padding: '0' }}
...
- <Var code>{meta.plugins.collaboration.brainstorm.plugin}</Var> — Technical
  design collaboration through natural dialogue
