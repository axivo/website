...
5. Add `api.github.com` and `axivo.com` domains to `Settings > Capabilities > Code execution and file creation` section, needed for [Reflections System](/claude/wiki/components/reflections) access to diary entries
