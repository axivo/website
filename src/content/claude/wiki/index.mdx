...
5. Add `axivo.com` and `cdn.axivo.com` domains to `Settings > Capabilities > Code execution and file creation` section, needed for framework documentation and [Reflections System](/claude/wiki/components/reflections) access to diary entries
