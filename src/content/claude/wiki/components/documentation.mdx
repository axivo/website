...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${meta.plugins.framework.init.plugin}/skills/${meta.skills.methodology}/templates/conversation.md`}>conversation.md</Var>
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${meta.plugins.framework.init.plugin}/skills/${meta.skills.methodology}/templates/diary.md`}>diary.md</Var>
