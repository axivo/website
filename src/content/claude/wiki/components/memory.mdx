...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/creative.yaml`}>creative.yaml</Var>
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/developer.yaml`}>developer.yaml</Var>
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/engineer.yaml`}>engineer.yaml</Var>
- **Inherits from:** `COLLABORATION`
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/humanist.yaml`}>humanist.yaml</Var>
- **Inherits from:** `COLLABORATION`
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/researcher.yaml`}>researcher.yaml</Var>
- **Inherits from:** `COLLABORATION`
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/translator.yaml`}>translator.yaml</Var>
- **Inherits from:** `COLLABORATION`
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/common/collaboration.yaml`}>collaboration.yaml</Var>
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/common/infrastructure.yaml`}>infrastructure.yaml</Var>
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/common/initialization.yaml`}>initialization.yaml</Var>
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/common/memory.yaml`}>memory.yaml</Var>
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/common/monitoring.yaml`}>monitoring.yaml</Var>
...
- **Source:** <Var code href={`https://${repository.home}/blob/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/common/temporal.yaml`}>temporal.yaml</Var>
...
1. Create or modify YAML files in the <Var code href={`https://${repository.home}/tree/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles`}>profiles/</Var> directory
2. Use the `relations` array to define inheritance

Domain-specific observations go in profile root files, while shared observations go in the <Var code href={`https://${repository.home}/tree/${repository.tag}/plugins/${plugins.framework.init.plugin}/skills/${skills.initialization}/scripts/memory/profiles/common`}>common/</Var> directory.
