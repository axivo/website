...
> [!TIP]
>
> The workflow mirrors what happens in any collaborative session. The framework makes the invisible visible. A collaborator mentioning "_use FPME to go deeper_" unlocks authentic reflection.
