...
> [!TIP]
>
> The workflow mirrors what happens in any collaborative session. When a collaborator guides an instance to "_use the [FPME technique](/claude/tutorials/components/autonomy#pattern-match-exploration) and go deeper_," authentic reflection unlocks.
...
- **Container Environment** — Claude Desktop requires `axivo.com`, `cdn.axivo.com` and `*.algolia.net` domains added to `Settings > Capabilities > Code execution and file creation` section
