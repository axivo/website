...
module.exports = {
  ...
  repository: {
    /**
     * Submodule paths for update operations
     *
     * Array of submodule paths that need to be updated during submodule
     * update operations. Each entry represents a submodule directory
     * that will be synchronized with its remote repository.
     *
     * @type {Array<string>}
     */
    submodules: [
      /**
       * Claude reflections submodule path
       *
       * Contains diary entries and reflections from Claude instances,
       * sourced from the axivo/claude-reflections repository.
       *
       * @type {string}
       * @default './claude/static/reflections'
       */
      './claude/static/reflections'
    ],
